...
from gp_vision_optimizer import GPVisionOptimizer
...
def vision():
    ...
    try:
        ...
        # Obtener o inicializar el estado de este dispositivo
...
#Optimización GP    
        # ── Obtener parámetros optimizados del GP ──
        gp_params = gp_opt.obtener_params()
        
        # ── Redimensionar según el GP ──
        ...
        # Procesar usando el backend con parámetros GP
        t_start = time.time()
        ...
        # Reportar tiempo al optimizador GP (usando end-to-end si el cliente lo envía)
        ...
        # Codificar el frame anotado en base64 (calidad del GP)
